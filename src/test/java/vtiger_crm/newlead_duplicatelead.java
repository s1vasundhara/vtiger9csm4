...
public class newlead_duplicatelead {
...
WebElement newlead=driver.findElement(By.className("hdrLink"));
	...
	if(newlead.isDisplayed())
		...
		WebElement duplicatelead=driver.findElement(By.className("lvtHeaderText"));
		
		if(duplicatelead.isDisplayed())
			System.out.println(" duplicate lead page is displayed");
		else
			System.out.println(" duplicate new lead page not dispalyed");
