...
/**
 * this call contains all reusable methods to perform driver related operations
 * @author admin
 *
 */
...
public class WebDriverUtility {
	...
	public String takeScreenshot(String className,JavaUtility jUtil, WebDriver sdriver)
	{
	...
	/**
	 * this method is used to take screenshot of the webpage and generators BASE64 image
	 * @return
	 */
	public String takesScreenShot()
	{
	 ...
	 /*
	  * This method is used to scroll till the specified web 
	  */
	  ...
	  */
	 public void closeCurrentWindow1() {
		 driver.close();
	 }
	 /*
	 ...
	 public WebElement convertStringToDynamicXpath(String commonpath,String replaceData) {
		 String requirePath=String.format(commonpath, replaceData);
		 return driver.findElement(By.xpath(requirePath));
	 }
